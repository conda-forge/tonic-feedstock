...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/tonic-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12733&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/tonic-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `tonic` can be installed with:

```
conda install tonic
```

It is possible to list all of the versions of `tonic` available on your platform with:
